                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control flat money text-right input-app"
                                                name="bpjs_ks" id="bpjs_ks" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<div class="modal fade" id="modal-kategori" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
            ...
            <form id="form-kategori" action="">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control flat" name="namakategori" type="text"
                            placeholder="Insert name kategori" autocomplete="off">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success flat" type="button" id="btnkategori"><i class="fa fa-floppy-o"></i>
                        Simpan</button>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="modal-subkategori" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-app flat">
                ...
                <div class="modal-body flat">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <input class="form-control flat" id="kategori" type="text" name="kategori"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <input class="form-control flat" name="name" type="text" id="name"
                                placeholder="Isikan Subkategori" autocomplete="off">
                            <div class="invalid-feedback"></div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary flat" id="btnsub" type="button"><i class="fa fa-floppy-o"></i>
                    Simpan</button>
            </div>
        </div>
        <!-- /.modal-content-->
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        ...
                        toastr.success('Kategori Produk Berhasil di ' + type + '!',
                            'Berhasil...');
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        ...
                        toastr.success('Subkategori Produk Berhasil di ' + type + '!',
                            'Berhasil...');
