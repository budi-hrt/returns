    ...
    <div class="animated fadeIn">
      <div class="row">
        <div class="col-lg-12">
          ...
          <a class="btn btn-success flat btn-sm mb-3" href="javascript:;" id="tambah"><i class="fa fa-file-o"></i> Tambah data Iuran Bpjs</a>
          <div class="card">
                  ...
                  <?php foreach ($bpjs as $b) : ?>
                    <tr>
                      <td class="text-center">
                        <a class="btn btn-sm btn-success item-edit flat" href="javascript:;" data="<?= $b['id_bpjs']; ?>" data-kode="<?= $b['kode_bpjs']; ?>" data-status="<?= $b['status']; ?>"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-sm btn-danger item-delete flat" href="javascript:;"><i class="fa fa-trash"></i></a>
                      </td>
