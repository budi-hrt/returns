                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="hitung-auto" style="display: none;">
                                        ...
                                        <div class="form-group row p_bruto mb-1">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text"
                                                    class="form-control form-control-sm flat  text-right " name="bruto"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                        ...
                                        <div class="form-group row jht mb-1">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text"
                                                    class="form-control form-control-sm flat  text-right " name="jht"
                                                    id="jht">
                                            </div>
                                        </div>
                                        <div class="form-group row jp mb-1">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text"
                                                    class="form-control form-control-sm flat  text-right " name="jp"
                                                    id="jp">
                                            </div>
                                        </div>
                                        <hr class="mb-1 mt-1">
