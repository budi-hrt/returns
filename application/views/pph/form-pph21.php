            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group row hitung" style="display: yes;">
                  ...
                  <div class="form-group row upah mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">Gaji pokok + Tunjangan</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right input-app" name="upah">
                    </div>
                  </div>
                  <div class="form-group row jkk mb-1" style="display: yes;">
                  ...
                  <div class="form-group row jk mb-1" style="display: yes;">
                  ...
                  <div class="form-group row p_bruto mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji"><b>Penghasilan Bruto</b></label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row mb-1" style="display: yes;">
                    <label class="col-md-3 col-form-label text-danger" for="gaji">Pengurangan :</label>
                    <!-- <div class="col-md-6">
                      <input type="text" class="form-control flat  text-right input-app" name="upah" readonly>
                    </div> -->
                  </div>
                  <div class="form-group row mb-1 by_jabatan" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">By.Jabatan 5%</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row jht mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">Iuran JHT 2%</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row jp mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">Iuran JP 1%</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <hr class="mb-1 mt-1">
                  <div class="form-group row neto_bulan mb-3" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji"><b>Penghasilan neto sebulan</b></label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row neto_tahun mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">Penghasilan neto setahun</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row ptkp mb-1 " style="display: yes;">
                  ...
                  <hr class="mb-1 mt-1">
                  <div class="form-group row pkp mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">PKP setahun</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row pembulatan mb-2" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">Pembulatan ke bawah</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row lima mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">5%</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row lima_belas mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">15%</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row dua_lima mb-1" style="display: yes;">
                  ...
                  <hr class="mb-1 mt-1">
                  <div class="form-group row terhutang mb-1" style="display: yes;">
                    <label class="col-md-5 col-form-label" for="gaji">PPh terhutang setahun</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control flat  text-right " name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row iuran_pph mb-1" style="display: yes;">
                    <label class="col-md-7 col-form-label" for="gaji"><b>PPh bulan ini : 100.000.000 /12</b></label>
                    <div class="col-md-5">
                      <input type="text" class="form-control flat  text-right" name="upah" readonly>
                    </div>
                  </div>
                  <div class="form-group row iuran_pph mb-1">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control flat  text-right input-app" name="iuran">
                    </div>
                  </div>
                  ...
                  <div class="form-group row keterangan mb-1">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control flat input-app" name="upah" placeholder="singkat & jelas..." autocomplete="off">
                    </div>
                  </div>
