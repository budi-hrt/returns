                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-border-app flat">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input class="form-control flat" type="text" placeholder="AUTO" disabled>
                                                    </div>
                                                </div>
                                                <!-- Barcode -->
                                                <div class="form-group row has-icon">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input class="form-control flat" id="barcode" type="text" name="barcode" value="<?= $produk['barcode']; ?>" autocomplete="off" value="<?= set_value('barcode'); ?>">
                                                    </div>
                                                </div>
                                                <!-- Nama Produk -->
                                                <div class="form-group row has-icon">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input class="form-control flat" id="nama" type="text" name="nama" value="<?= $produk['nama_barang']; ?>" autocomplete="off" value="<?= set_value('nama'); ?>">
                                                    </div>
                                                </div>
                                                <!-- Merek produk -->
                                                <div class="form-group row has-icon">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="text" name="merek" id="merek" class="form-control flat" value="<?= $produk['nama_merek']; ?>">
                                                    </div>
                                                    <div class="col-md-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row has-icon">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <input type="text" name="kategori" id="kategori" class="form-control flat" value="<?= $produk['nama_kategori']; ?>">
                                                    </div>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input class="form-control" id="minStok" type="number" name="minStok" value="<?= $produk['stok_minim']; ?>" autocomplete="off" value="<?= set_value('minStok'); ?>">
                                                    </div>
                                                </div>
                                                <!-- aktif -->
                                                <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control flat money" id="isi2" type="number" name="isi2" value="<?= $produk['isi2']; ?>" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Akhir col isi -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                </span><input type="text" class="form-control datepicker1 flat" name="tanggal_mulai[]" id="tanggal_mulai<?= $tm++; ?>" value="<?= $l['tanggal_mulai']; ?>">
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class=" input-group">
                                                                ...
                                                                </span><input type="text" class="form-control datepicker2 flat" name="tanggal_selesai[]" id="tanggal_selesai<?= $ts++; ?>" value="<?= $l['tanggal_selesai']; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                        ...
                        <div class="card-footer">
                            <button class="btn btn-sm btn-success flat" id="btn-edit" type="button">
...
<script>
    ...
    $('#btn-edit').on('click', function() {
        ...
        if (nama == '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?= base_url('barang/barang/edit'); ?>',
                data: {
                ...
                success: function() {
                    ...
                    setTimeout(function() {
                        ...
                        toastr.success('Data Produk Berhasil di Ubah', 'Berhasil...');
