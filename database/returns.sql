...
INSERT INTO `tb_gaji` (`id_gaji`, `id_kry`, `gaji_pokok`, `tunjangan`, `um`, `date_update`, `id_user`) VALUES
(1, 1, 15000000, 5000000, 1500000, 1644758394, 1),
(2, 2, 5200000, 850000, 0, 1644758432, 1),
(3, 3, 5500000, 0, 0, 1644759044, 1),
...
--
ALTER TABLE `detil_pembelian`
  MODIFY `id_detil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
