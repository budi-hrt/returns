...
--
-- Host: localhost:3306
-- Generation Time: May 26, 2022 at 01:45 PM
...
(21, 9, 'Penggajian', 'gaji/penggajian', 'icon-credit-card', 1),
(22, 9, 'Management Gaji', 'gaji/management_gaji', 'icon-calculator', 1),
(23, 9, 'Iuran Bpjs', 'gaji/bpjs', 'icon-umbrella', 1),
(24, 9, 'Iuran PPH21', 'gaji/pph21', 'icon-support', 1),
(25, 6, 'Master PTKP', 'master/ptkp', 'icon-tag', 1);
...
--
-- AUTO_INCREMENT for table `tb_pph21`
--
ALTER TABLE `tb_pph21`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
